...
export const mockServices: ServiceInfo[] = [
  {
    ...
    geofence: ['us', 'ca', 'uk'],
    title_regex: 'netflix\\.com/watch/(\\d+)',
    help: 'Netflix streaming service - requires active subscription',
  },
  {
    tag: 'DSNP',
    ...
    geofence: ['us', 'ca', 'au'],
    title_regex: 'disneyplus\\.com/(\\w+)/(\\w+)',
    help: 'Disney+ streaming service',
  },
  {
    tag: 'AMZN',
    ...
    geofence: ['us', 'uk', 'de'],
    title_regex: null,
    help: 'Amazon Prime Video streaming service',
  },
  {
    tag: 'ATVP',
    url: 'https://tv.apple.com',
    aliases: ['appletv', 'apple+'],
    geofence: ['us'],
    title_regex: null,
    help: 'Apple TV+ streaming service',
  },
  {
    tag: 'MAX',
    url: 'https://max.com',
    ...
    geofence: ['us'],
    title_regex: null,
    help: 'Max (formerly HBO Max) streaming service',
  },
];
...
export const mockDownloadJobs: DownloadJob[] = [
  {
    job_id: 'job_001',
    service: 'NF',
    title_id: 'https://netflix.com/watch/stranger_things_s4e1',
    ...
    created_time: new Date(Date.now() - 10 * 60 * 1000).toISOString(),
    started_time: new Date(Date.now() - 10 * 60 * 1000).toISOString(),
  },
  {
    job_id: 'job_002',
    service: 'DSNP',
    title_id: 'https://disneyplus.com/watch/mandalorian_s3e1',
  ...
  },
  {
    job_id: 'job_003',
    service: 'NF',
    title_id: 'https://netflix.com/watch/ozark_s4e7',
    ...
    started_time: new Date(Date.now() - 2 * 60 * 60 * 1000).toISOString(),
    completed_time: new Date(Date.now() - 90 * 60 * 1000).toISOString(),
  },
  {
    job_id: 'job_004',
    service: 'AMZN',
    title_id: 'https://amazon.com/watch/jack_ryan_s1e1',
    content_title: 'Jack Ryan S1E1: Pilot',
    status: 'failed',
    error_message: 'Authentication required: Please log in to Amazon Prime Video',
    created_time: new Date(Date.now() - 30 * 60 * 1000).toISOString(),
    started_time: new Date(Date.now() - 30 * 60 * 1000).toISOString(),
  },
];
